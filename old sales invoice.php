					...
					<table id="sample_table1" style="display:none;">
						<tbody>
							<tr class="main_tr1" style="border:1px;border-style:solid;">
								...
								<td style="border:1px;border-style:solid;">
								<input class="form-control input-medium icode" placeholder="Item Code" required name="item_code[]" autocomplete="off" type="text" value="">
								</td>
								<td style="border:1px;border-style:solid;width:20%;">
									<input class="form-control input-medium name" placeholder="Item Name" required name="item_name[]" autocomplete="off" type="text" value="">
							</td>
