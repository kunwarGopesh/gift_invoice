...
if(isset($_POST['submit']))
		...
		{	
			...
			mysql_query("insert into `payment_transaction_ledgers` SET `supplier_id`='$supp_id',`amount`='$new_amount',`transaction_date`='$payment_date'");
					...
					?>
										<tbody>
													<tr>
														...
														<td><a href="view_purchase.php?invoice_id=<?php echo $invoice_id;?>" ><?php echo $invoice_id;?></a></td>
				...
				<?php  }?>
											...
											<form method="post"  class="form-horizontal">
												<tr style="background-color:#BB968E;">
													...
													<th><a style="color:white;" href="supplier_payment_ledger.php?supp_id=<?php echo $supplier_ids;?>"><?php echo number_format($total_cash,2);?></a></th>
