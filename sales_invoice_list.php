	...
	<div class="page-content-wrapper">
		...
		<div class="row">
			...
			<div class="portlet-title ">
				<div class="caption">
					<i class="fa fa-gift"></i>View Sales Invoices
				</div>
			</div>
			<div class="portlet-body form">
			 <div class="table-scrollable">
							 ...
							 <?php
									$r1=mysql_query("select * from `sales_invoice`");		
										$i=0;
										while($row1=mysql_fetch_array($r1))
										{
										$i++;
										$sale_invoice_id=$row1['id'];
                    ...
                    <tbody>
								<tr>
									...
									<td class="search">
									<?php echo $sale_invoice_id;?>
									</td>
									<td class="search">
									<?php echo $company;?>
									</td>
									<td class="search">
									<?php echo fetchcustomername($customer_id);?>
									<td class="search">
			  ...
			  <div class="modal fade" id="delete<?php echo $sale_invoice_id;?>" tabindex="-1" aria-hidden="true" style="padding-top:35px">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" name="delete<?php echo $sale_invoice_id ;?>">
                            <input type="hidden" name="delet_class" value="<?php echo $sale_invoice_id; ?>" />
